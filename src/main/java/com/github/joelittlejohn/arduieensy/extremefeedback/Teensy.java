...
public class Teensy {
    ...
    public void write(Pin pin, int value) throws PortAccessException {
        try {
            ...
            throw new PortAccessException(format("Unable to write value %d to Teensy pin %d", value, pin), e);
        }
    }
    ...
    private OutputStream getOutputStream() throws PortAccessException {
        ...
        throw new PortAccessException("Enumerated all ports but couldn't find the serial port");
    }
